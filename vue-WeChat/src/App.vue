    ...
    export default {
        ...
        watch: {
            ...
            "$route" (to, from) {
                ...
                this.enterAnimate = toDepth > fromDepth ? "wx-slide-in-right" : "wx-slide-in-left"
                this.leaveAnimate = toDepth > fromDepth ? "wx-slide-out-left" : "wx-slide-out-right"
                    // 从店面页进入店内页 需要对店内页重新设置离开动效 因为他们处于不同 name 的 router-view
                if (toDepth === 3) {
                    this.leaveAnimate = "wx-slide-out-right"
                }
            }
        }
    }
